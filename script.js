    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "A.D.I.R. Productions משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'b05403b8-753d-435c-9768-f30b64209990',
                    name: data.name || '',
                    email: data.email || '',
